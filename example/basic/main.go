...
//
//	$ go get -d vortex.studio/mobile/example/basic
//	$ gomobile build vortex.studio/mobile/example/basic # will build an APK
//
//	# plug your Android device to your computer or start an Android emulator.
//	# if you have adb installed on your machine, use gomobile install to
//	# build and deploy the APK to an Android target.
//	$ gomobile install vortex.studio/mobile/example/basic
//
...
//
//	$ go install vortex.studio/mobile/example/basic && basic
package main
...
import (
	...
	"vortex.studio/mobile/exp/app/debug"
